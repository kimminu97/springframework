...
public class HomeController {
	...
	public void search(String name, int age) {	
		//메소드의 매개변수는 url 요청 파라미터(쿼리 스트링)를 전달받게 됩니다.
	...
	}	//view는 자동으로 model.jsp	-> 이 용청에 대한 request,response를 jsp로 전달
	...
	public String redirect(Model model) {
		...
		//실행 했을때 url을 확인 : http://localhost:8085/app/?idx=99
	}
